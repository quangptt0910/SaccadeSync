// Adjustment for webapp with webcam.
// Algorithm used the desktop eye tracker standard
// NEED TO ADJUST For Webcam LIMITATION
// ============================================================================
...
//     }
//
//     //  Find fixation point BEFORE saccade (baseline)
...
//
//     //  Capture landing point at T_land + 67ms (Saccadic Gain measurement)
...
//     });
//
//     //  Validate Sustained Fixation (300ms in ROI - target area)
...
//
//     // Calculate final accuracy score (multi-component)
